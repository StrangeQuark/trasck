...
| `import_materialization_runs` | `id`, `workspace_id`, `import_job_id`, `mapping_template_id`, `transform_preset_id`, `transform_preset_version`, `project_id`, `requested_by_id`, `update_existing`, mapping/template/transform snapshots, status/counts, `created_at`, `finished_at` |
