...
59. Frontend components should use feature-specific API services and hooks around the generated `TrasckApiClient`; the generated TypeScript client and `openapi.json` stay committed as the reviewed contract snapshot while the API is moving quickly. The Vite frontend uses route-based navigation rather than a single tabbed console shell, and the Project Settings route is the long-term home for project-admin settings as additional project-scoped configuration APIs are added.
