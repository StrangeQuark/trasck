...
- Setup, auth login/register/OAuth/login/logout, health, and public project/work-item reads are explicitly permitted.
...
- Anonymous public project/work-item reads still perform domain-level visibility checks; security configuration alone is not the access-control source of truth.
