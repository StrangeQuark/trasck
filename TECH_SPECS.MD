...
- `GET /api/v1/auth/context` returns the authenticated user plus active workspace memberships, active project memberships, and default workspace/project selections for the product shell.
