...
| `webhooks` | `id`, `workspace_id`, `name`, `url`, `secret_hash`, `secret_encrypted`, `secret_key_id`, previous-secret hash/encrypted/key ID overlap fields, `secret_rotated_at`, `previous_secret_expires_at`, `event_types`, `enabled` |
