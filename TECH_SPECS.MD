...
| `webhooks` | Outbound webhook definitions with redacted secret hash and encrypted secret material for delivery signing. |
...
| `webhooks` | `id`, `workspace_id`, `name`, `url`, `secret_hash`, `secret_encrypted`, `event_types`, `enabled` |
