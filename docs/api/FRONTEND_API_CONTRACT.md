...
- Agents: providers create/update/deactivate, credentials, callback keys, profiles create/update/deactivate, repository connections create/list/deactivate, assignment, dispatch attempts, worker dispatch, worker protocol, callbacks, task messages/artifacts/review actions.
