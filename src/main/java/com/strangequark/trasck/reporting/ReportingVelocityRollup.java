...
@DynamicInsert
@DynamicUpdate
@Table(name = "reporting_velocity_rollups")
public class ReportingVelocityRollup {
    @Id
    ...
    public BigDecimal getCarriedOverPoints() { return carriedOverPoints; }
    public void setCarriedOverPoints(BigDecimal carriedOverPoints) { this.carriedOverPoints = carriedOverPoints; }
